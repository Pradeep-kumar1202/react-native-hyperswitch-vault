...
type contextValue = {
  ...
  unstyled: bool,
  /*
   * The surface's error-display default: `#none` when the merchant composed the fields themselves,
   * `#inline` for the ready-made form. It rides the context for the same reason `unstyled` does —
